...
{
    public sealed class JetpackVisibilityOption : IToggle, IMenuItem
    {
        private const string Label = "Show jetpack";
        private const int Padding = 2;
        private Point labelSize;

        public JetpackVisibilityOption()
        ...
        {
            SettingsStore.SetShowJetpack(toggle);
        ...
        private static bool GetInitialValue()
        {
            ...
            return SettingsStore.Current.ShowJetpack;
        }
